...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <span className="text-4xl">V</span>ezet <span className="text-orange-500">Digital Solutions</span>
      </Link>
      <div>
        <button
                ...
                <div className="w-full  gap-10 md:gap-40  flex">
                  <div className="flex-1 hidden md:block">
                    <h1 className="text-[calc(1rem+1vw)] leading-[1.2] ">
                     Propel Growth With Vezét,
                    </h1>
                    <h1 className="text-[calc(1rem+1vw)] leading-[1.2] ">
                     Your Digital Catalyst
                    </h1>
                    <div className="flex flex-col gap-5 mt-10 text-grey-2">
                      <p>Vezét Digital Solutions</p>
                      <p>
                        Phone -{" "}
                        <a
                          href="tel:+91 9790458882"
                      ...
                      <p>
                        Email -{" "}
                        <a
                          href="mailto:vezet@tutanota.com"
                          className="hover:text-foreground transition-colors"
                        >
                          vezet@tutanota.com
                        </a>
